...
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = os.getenv("DEFAULT_FROM_EMAIL", "Вышка.Клуб <club@vyshka.club>")
...
MEDIA_UPLOAD_URL = "http://media.vyshka.club/upload/multipart/"
...
CLEARED_POST_TEXT = "```\n" \
    ...
    "Если вы хотите приютить и развить эту тему как новый автор, напишите модераторам Клуба: moderator@vyshka.club." \
    "\n```"
