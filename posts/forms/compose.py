        ...
        widget=forms.Textarea(
            attrs={
                ...
                "placeholder": "Напишите TL;DR чтобы сэкономить другим время."
                               "\n\nКоротко расскажите про условия акции, перечислите основные моменты, "
                               "которые вас зацепили, и почему каждый студент должен ей воспользоваться."
...
class PostGuideForm(PostForm):
    title = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": "Гайд по выживанию: ******",
                "value": "Гайд по выживанию: ******",
            }
        ),
    )
    text = forms.CharField(
        ...
        initial="Ниже приведён шаблон, который вы можете редактировать как вам будет удобнее.\b\b"
                "Напишите пару предложений введения: как проходила ваша адаптация после поступления в универ, с какими трудностями столкнулись в начале, как их решили преодолеть?\n\n"
                "P.S. Помните, что гайд очень сильно помогает первокам и особенно иностранным студентам. Так что работая над ним, вы делаете благое дело\n\n"
                "# Карта города\n\n"
                "Обведите на ней все главные места — где ваш корпус, где жить, где транспорт, где тусить, где есть, где ходить. "
                ...
                "   - [теплую одежду, разветвитель, спальные принадлежности, или просто ничего]\n"
                "- **Как лучше перемещаться по городу?**\n"
                "   - [Использовать метро, электрички, автобусы или трамваи? Где можно пройти зайцем и где действует скидка на проезд?]\n"
                "- **Лучший путь от жилья до универа?**\n"
                "   - [Когда в метро меньше всего людей? Комфортные маршруты, если нужно работать по пути в ноутбуке.]\n"
                "- **Можно ли пить воду из крана в вашем районе?**\n"
                "   - [да/нет/ваш вариант]\n"
                "- **Главные супермаркеты для еды?**\n"
                "   - [Названия и чем отличаются, какие работают 24 часа]\n"
                "- **Где можно дёшево пообедать?**\n"
                "   - [Хорошие столовые рядом с вашим корпусом, или просто вкусные перекус по пути]\n"
                "- **Где лучше заниматься спортом?**\n"
                "   - [Стадионы или тренировочные залы для самых разных типов тренировок. Какие из них дешевле и чем отличаются?]\n"
